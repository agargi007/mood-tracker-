<template>
  <div class="welcome-summer-bg min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden" style="overflow-x:hidden; overflow-y:hidden;">
    <div class="flex flex-col items-center justify-center w-full min-h-screen">
      ...
      <h1 class="welcome-title font-display font-extrabold mb-10 md:mb-14 text-gray-800 tracking-tight drop-shadow-lg animate-gradient-text animate-fade-in"
        style="font-size: clamp(2.5rem, 8vw, 6.5rem); line-height: 1.1; width: 100vw; text-align: center; display: flex; align-items: center; justify-content: center;">
